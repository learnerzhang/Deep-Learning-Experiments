...
# Step 1: Download the mnist_data.
...
# Read the mnist_data into a list of strings.
...
print('Sample mnist_data', data[:10], [reverse_dictionary[i] for i in data[:10]])
...
with tf.Session(graph=graph) as session:
    ...
    for step in xrange(num_steps):
        ...
        if step % 2000 == 0:
            # Log tensorboard mnist_data every 2000
