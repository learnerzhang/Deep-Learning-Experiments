...
# must run mnist_a2j_2pickle.py first (one-time) to generate the mnist_data
...
# use of pickle to speed up loading of mnist_data
...
with graph.as_default():
    # Input mnist_data. For the training mnist_data, we use a placeholder that will be fed
